package com.busanit501.jsp_server_project1_test.test_todo.listener;

import com.busanit501.jsp_server_project1_test.test_todo.dao.ConnectionUtil;
import com.busanit501.jsp_server_project1_test.test_todo.dao.ConnectionUtil;
...
public class TodoContextListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        ConnectionUtil.INSTANCE.closePool();
    }
}
