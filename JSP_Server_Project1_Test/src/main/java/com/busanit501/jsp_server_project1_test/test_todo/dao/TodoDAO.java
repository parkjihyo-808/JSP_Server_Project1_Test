package com.busanit501.jsp_server_project1_test.test_todo.dao;

import com.busanit501.jsp_server_project1_test.test_todo.domain.TodoVO;
...
public class TodoDAO {
    ...
    public String getTime() {
        ...
        try (Connection connection = com.busanit501.jsp_server_project1_test.test_todo.dao.ConnectionUtil.INSTANCE.getConnection();
             // 현재 시간을 조회하는 쿼리를 전달하고
    ...
    public String getTime2() throws Exception {
        ...
        @Cleanup Connection connection = com.busanit501.jsp_server_project1_test.test_todo.dao.ConnectionUtil.INSTANCE.getConnection();
        // 현재 시간을 조회하는 쿼리를 전달하고
